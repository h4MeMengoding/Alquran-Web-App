...
$.ajax({
   ...
   success: results => {
      ...
      const fragmentQuotes = `
        <h6 class="text-start" style="color: white;">Quotes Islami Untukmu:</h6>
        <h2 class="text-end my-3" style="color: white;">${quotesRandom.arabic}</h2>
        <h6 class="text-start" style="font-style: italic; font-weight: 400; color: white;">${quotesRandom.arti}</h6>
      `
